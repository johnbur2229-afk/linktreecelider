      ...
      <div className="container mx-auto max-w-2xl">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[3rem] p-10 text-center shadow-2xl">
          ...
          <div className="mb-10 pb-8 border-b border-white/5">
            <p className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-blue-400 font-black">
          ...
          <div className="mb-10">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="px-6 py-2.5 bg-white/5 border border-white/10 rounded-full text-white hover:bg-blue-500/20 hover:border-blue-500/50 transition-all text-sm font-bold shadow-lg shadow-black/20"
              >
                Marito Senior
              </a>
              <a 
          ...
          <div className="mt-4">
            <a 
              ...
              target="_blank"
              rel="noreferrer" 
              className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white rounded-2xl text-sm font-black transition-all shadow-xl shadow-blue-600/20 hover:scale-[1.02] active:scale-95"
            >
