  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        className="w-full pl-14 pr-12 py-4 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:bg-white/[0.07] transition-all duration-300 shadow-inner"
      ...
      <div className="absolute -inset-px bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl opacity-0 group-focus-within:opacity-100 pointer-events-none transition-opacity duration-500" />
    </div>
  )
}
